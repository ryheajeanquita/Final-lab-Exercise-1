...
//API response formatting, headers, JSON output
$studentProfiles = [
    [ // Student 1
        "id" => 1,
        "name" => "Jean Calvin Nueva",
...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>JSON Encode/Decode Example</title>
  </head>
...
<hr>
<br>
                <i class="mt-2 text-blue-400">JSON String Decoded</i>
...
<br>
                <!-- API response formatting, headers, JSON output. -->
                <i class="mt-2 text-blue-400">JSON Response API Simulation</i>
                <i class="mt-2 text-red-400">header("Content-Type: application/json")</i>
                <i class="mt-5 text-green-400">*Pretty-print* &#10004;</i>

                <pre class="mt-2 text-gray-400 bg-zinc-900 p-4 rounded-lg"><?php
